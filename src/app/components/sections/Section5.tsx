...
const Section5 = () => {
    return (
        <section
        id="section5"
        className="bg-drive lg:h-80 m-8 lg:m-20 lg:mx-32 lg:p-4 rounded-3xl flex flex-col lg:flex-row justify-evenly items-center lg:items-end p-6 lg:p-8 lg:p-0 lg:px-20 my-14"
      >
